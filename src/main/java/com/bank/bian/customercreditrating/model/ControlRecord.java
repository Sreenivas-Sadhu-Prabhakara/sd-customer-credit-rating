package com.bank.bian.customercreditrating.model;
...
/**
 * The BIAN control record for this service domain: "Credit Rating Assessment".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Assess) applied
 * to its asset type (Credit Rating). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Credit Rating Assessment";
